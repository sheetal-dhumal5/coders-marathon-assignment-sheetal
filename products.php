...
// If search string
if ($search_string) {
	$db->where('product_name', '%' . $search_string . '%', 'like');
}
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo xss_clean($row['product_name']); ?></td>
                <td><?php echo xss_clean($row['product_category']); ?></td>
                <td><?php echo xss_clean($row['product_description']); ?></td>
                <td>
